function generateHeader(navSize = "20px", titleSize = "45px", width = "55%", margin = "auto", title = "MILES LIU") {
    ...
    header.innerHTML = `<div class="sitenavbar" id="navblock" style="width: ` + width + `; margin: ` + margin + `;">
    ...
    <div class="nav">
        ...
        <a class="nav-link navtext" style="font-size: ` + navSize + `;" href="https://mliu59.github.io/projects">PROJECTS & WORK EXPERIENCE</a>
